    ...
    <div className="max-w-screen-lg mx-auto p-4 lg:p-0 my-8">
      ...
      <div className="w-full h-full">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-4">
          ...
          {posts.map((item) => (
            <div key={item.id} className="h-[30vh] lg:h-[40vh] border rounded border-gray-300 w-full flex flex-col justify-between items-center shadow-md hover:shadow-lg hover:bg-zinc-50">
              <span
